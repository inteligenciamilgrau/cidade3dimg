...
createVoxel(-0.2, 2.6, 0.41, 0.15, 0.15, 0.05, faceM);
createVoxel(0.2, 2.6, 0.41, 0.15, 0.15, 0.05, faceM);
createVoxel(0, 2.3, 0.41, 0.4, 0.1, 0.05, faceM);
createVoxel(-0.25, 2.35, 0.41, 0.1, 0.1, 0.05, faceM);
createVoxel(0.25, 2.35, 0.41, 0.1, 0.1, 0.05, faceM);
...
player.add(pBody, pHead, pArmL, pArmR, pLegL, pLegR);
